...
:description: Summarise what this explanation is about. What you put here is reused in the Overview section and included in HTML description tags.
...
For help with writing and structuring an explanation article, see the README.adoc in the template directory for basic guidelines and links.
